...
- (void)viewDidLoad {
    ...
    self.navigationController.navigationBar.translucent = NO;//取消导航的影响
    ...
    [[CHDDropDownMenu alloc] initWithFrame:CGRectMake(0, 0,CHD_SCREEN_WIDTH, 40) showOnView:self.view AllDataArr:arr showArr:ShowArr];
